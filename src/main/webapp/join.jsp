...
<div class="login-form" style="margin-bottom: 10px;">
  ...
  <form class="form-horizontal" action="enter" method="post">
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input type="text" name="Enter" value="" placeholder="输入您的企业名称" class="input-xlarge" required>
            <p class="help-block">全称</p>
          </div>
        </div>
    ...
    <div class="control-group">
          ...
          <!-- Text input-->
          <label class="control-label" for="input01">企业类型</label>
          <div class="controls">
            <input type="text" name="type" value="" placeholder="企业类型" class="input-xlarge" require>
            <p class="help-block">投资/控股/私立</p>
          </div>
        </div>
    ...
    <div class="control-group">
          ...
          <!-- Text input-->
          <label class="control-label" for="input01">经营范围</label>
          <div class="controls">
            <input type="text" name="scope" value="" placeholder="企业经营范围" class="input-xlarge" require>
            <p class="help-block">涉及的服务</p>
          </div>
        </div>
    ...
    <div class="control-group">
          ...
          <!-- Text input-->
          <label class="control-label" for="input01">企业成立时间</label>
          <div class="controls">
            <input type="text" name="start_time" value="" placeholder="企业成立时间" class="input-xlarge" require>
...
<!--           <input type="submit" value="提交"> -->
            <button class="btn btn-success" value="Submit" type="submit"  name="action1">提交</button>
